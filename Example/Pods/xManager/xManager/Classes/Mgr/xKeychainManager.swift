...
public class xKeychainManager: NSObject {
                       ...
                       forKey key : String) -> Bool
    {
        ...
        case errSecSuccess:
            ...
            case errSecSuccess:
                ...
                return true
            default:
                print(">>>>>>>> Keychain更新失败❎:\(status)")
                return false
            }
        default:
            print(">>>>>>>> Keychain没有找到\(key)对应的数据❎:\(status)")
            return false
        }
    }
    ...
    public func query(valueForKey key : String) -> Data?
    {
        ...
        case errSecSuccess:
            ...
            print(">>>>>>>> Keychain查找的数据类型无法识别❎")
            return nil
        case errSecItemNotFound:
            print(">>>>>>>> Keychain没有找到\(key)对应的数据❎")
            return nil
        default:
            print(">>>>>>>> Keychain查找失败❎:\(status)")
            return nil
        }
    }
